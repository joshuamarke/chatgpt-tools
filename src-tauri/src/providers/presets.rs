...
fn all_presets() -> Vec<ProviderPreset> {
    vec![
        ...
        ProviderPreset {
            ...
            notes: Some("填写你的中转 / 聚合站 Base URL 与 API Key".into()),
        ...
        ProviderPreset {
            ...
            wire_api: "responses".into(),
            notes: Some("OpenRouter 聚合；模型 id 含厂商前缀".into()),
        ...
        ProviderPreset {
            ...
            wire_api: "chat".into(),
            notes: Some("DeepSeek 官方 API（Chat Completions）".into()),
        ...
        ProviderPreset {
            ...
            model: "gpt-4o".into(),
            wire_api: "chat".into(),
            notes: Some("任意 OpenAI-compatible /v1 网关".into()),
            category: Some("custom".into()),
        },
        // ── Grok ──────────────────────────────────────────────
        ProviderPreset {
